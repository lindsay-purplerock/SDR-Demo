...
map.getView().fit([-963838.216366, 6803411.745648, -780744.638097, 7009957.878238], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Strategic Dashboard for Resources - DEMO</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (284 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This web map demonstrates a small subset of the Strategic Data for Resources (SDR) data availible for Tipperary County, Ireland. The included layers show information relative to the \'E\'  axis of the United Nations Framework Classification system Environmental-Socioeconomic Viability.';
            }
