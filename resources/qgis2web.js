...
map.getView().fit([-988223.885313, 6814793.227096, -804864.894451, 7021481.071011], map.getSize());
    ...
    element: (() => {
        ...
        if (291 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This web map demonstrates a small subset of the Strategic Dashboard for Resources (SDR) data availible for Tipperary County, Ireland. The included layers show information relative to the \'E\' (Environmental-Socioeconomic Viability)  axis of the United Nations Framework Classification system.';
            }
